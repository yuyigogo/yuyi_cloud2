...
from vendor.django_mongoengine.mongo_admin.util import (
    display_for_field,
    help_text_for_field,
    label_for_field,
)
...
class AdminReadonlyField(DjangoAdminReadonlyField):
    ...
    def contents(self):
        ...
        try:
            ...
            # https://stackoverflow.com/questions/18324030/how-to-change-empty-changelist-value-in-django-admin
            result_repr = ugettext_lazy("(None)")
        else:
            if f is None:
