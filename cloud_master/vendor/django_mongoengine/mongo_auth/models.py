...
from vendor.django_mongoengine import document, fields
...
class AbstractUser(BaseUser, document.Document):
    ...
    def check_password(self, raw_password):
        ...
        """
        # If self.password is None, the user is not activated
...
class MongoUser(BaseUser, models.Model):
    ...
    The actual user document class is vendor.django_mongoengine.auth.models.User or any
