...
class MongoSession(Document):
    session_key = StringField(primary_key=True, max_length=40)
    session_data = StringField() if MONGOENGINE_SESSION_DATA_ENCODE else DictField()
...
class BSONSerializer(object):
    ...
    def dumps(self, obj):
        return dumps(obj, separators=(",", ":")).encode("ascii")
